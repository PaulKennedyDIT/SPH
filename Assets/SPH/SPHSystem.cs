...
public class SPHSystem : MonoBehaviour 
{
	...
	private SPH sph;								// Instansiation of Smooth Particle Hydrodynamic object. Performs the SPH calculations.
	private FluidParticle tempFluidParticle;		// Instansiation of a temporary Fluid Particle Object.
	...
	private static float UpdateTime = 0.05f;		// Instansiation of the Time Delta used for Updating each particle per time slice.
